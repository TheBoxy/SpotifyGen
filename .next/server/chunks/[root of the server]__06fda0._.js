...
async function handler(req, res) {
    ...
    const prompt = `Based on these top songs: ${songList}, describe what kind of 'era' this person is currently in.`;
    ...
    res.status(200).json({
        era: response.choices[0].message.content
    });
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__06fda0._.js.map