...
async function handler(req, res) {
    ...
    const timeRangeText = timeRangeToText[timeRange] || 'last month';
    ...
    try {
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a music analyst with a background in psychology who creates visually appealing, well-formatted text responses."
                },
                {
                    role: "user",
                    content: prompt
